...
export async function createReview(req , res){
    try{
        ...
        const user = req.user;
        //verificar que existe order y delivered
        ...
        //verificar producto en la order
...
export async function deleteReview(req , res){
    try{
        ...
        await Product.findByIdAndUpdate(productId , {
            averageRatings: reviews.length > 0 ? totalRating / reviews.length : 0,
